...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { row: @business.row, seats_in_row: @business.seats_in_row } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { row: @business.row, seats_in_row: @business.seats_in_row } }
